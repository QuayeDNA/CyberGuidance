  ...
  const submitBooking = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        toast.info(
          "Your appointment request has been sent to the admin for processing. You will receive a confirmation soon.",
          {
            autoClose: 5000,
          }
        );
          ...
          <motion.div
            ...
            <motion.div
              ...
              <textarea
                ...
                value={bookingReason}
                onChange={(e) => setBookingReason(e.target.value)}></textarea>
              <div className="flex justify-end space-x-4">
                <button
                  className="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400 transition duration-300"
                  onClick={() => setIsBookingModalOpen(false)}>
