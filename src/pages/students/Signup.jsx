  ...
  const handleSignup = async (data, retryCount = 0) => {
    ...
    try {
      ...
      if (error.message.includes("timeout") && retryCount < 2) {
        ...
        setError(
          `Request timed out. Retrying... (Attempt ${retryCount + 1} of 3)`
        );
    ...
    <div className="flex flex-col min-h-screen">
      <div className="relative flex-grow flex items-center justify-center">
        ...
        {!showCard ? (
          ...
          <div className="relative z-10 bg-white p-5 rounded-lg shadow-lg w-full max-w-md m-3 transition-all duration-500 ease-in-out transform hover:scale-105">
            <h2 className="xl:text-3xl md:text-2xl sm:text-xl font-bold text-center mb-6 text-blue-600">
              Sign Up for E-Counselling
            </h2>
