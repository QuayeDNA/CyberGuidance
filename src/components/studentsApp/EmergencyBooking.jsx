...
import { bookEmergencyAppointment } from "../../axiosServices/reportApi"; // Import the API function

const EmergencyBookingButton = ({
  counselorId,
  counselorName,
  isOpen,
  onClose,
                ...
                {bookingStatus === "initial" && (
                  <div className="text-center py-8">
                    <p className="text-lg font-medium text-gray-900 mb-4">
                      Are you sure you want to request an emergency session with{" "}
                      {counselorName}?
                    </p>
                    <button
